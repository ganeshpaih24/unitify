...
// function tabChangeFunction(unitNumber) {
//   //unitNumber= index of tabChangeArray
...
//   isEven(unitNumber) || unitNumber == 0
//     ? (tabChangeArray[unitNumber].style.display = tabChangeArray[
//         unitNumber + 1
//       ].style.display =
//         'block')
//     : (tabChangeArray[unitNumber].style.display = tabChangeArray[
...
//   if (num == 0)
//     inputUnitIndex =
//       selectedInputValue[factorIndex]
//         .selectedIndex; //the unit chosen in input select attribute is stored in the form of index in inputUnitIndex
//   else
//     outputUnitIndex = selectedOutputValue[factorIndex].selectedIndex; //the unit chosen in output select attribute is stored in the form of index in outputUnitIndex
// }
